...
- [Frontend usuarios](https://github.com/Luis-Mendaro/patitas-unidas-front-usuarios)  
- [Frontend refugios](https://github.com/Luis-Mendaro/patitas-unidas-front-refugios)  
- [Backend API](https://github.com/Luis-Mendaro/patitas-unidas-back)

---

## 📂 Otros proyectos / en progreso

- **DevOps Journey 2025** – Infraestructura modular y CI/CD (privado)  
- **JS Fundamentals** – Práctica de JavaScript (privado)
